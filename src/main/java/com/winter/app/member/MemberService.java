...
public class MemberService {
	...
	public Map<String, Object> login(MemberDTO memberDTO) throws Exception { // 사용자가 입력한 id,pw
		Map<String, Object> map = new HashMap<String, Object>();// 객체를 만들 수 있는 클래스 = 구현클래스
