	                                ...
	                                <div class="card shadow-lg border-0 rounded-lg mt-5">
										...
										<form id="frm" action="./join" method="post" enctype="multipart/form-data">
											<div class="card-body">
												...
												<div class="row mb-3">
													<div class="col-md-6">
														<div class="form-floating">
															<input class="form-control ch" id="member_pwd"	type="password" placeholder="Password" name="member_pwd" />
													...
													<div class="col-md-6">
														<div class="form-floating">
															<input class="form-control ch" id="member_pwd_check" type="password" placeholder="Password_Check" />
												...
												<div class="form-floating mb-3">
													<input class="form-control ch" id="email" type="email" placeholder="email@example.com" name="email" />
													<label for="email">Email 주소</label>
												</div>
												<div class="row mb-3">
													<div class="col-md-6">
														<div class="form-floating mb-3 mb-md-0">
															<input class="form-control ch" id="member_name" 	type="text" placeholder="Name" name="member_name" /> 		
															<label for="member_name">이름</label>
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-floating mb-3 mb-md-0">
															<input class="form-control ch" id="member_number"
																type="text" placeholder="Resident registration number"	name="member_number" /> 
																<label for="member_number">주민번호</label>
														</div>
													</div>
												</div>
												<div class="form-floating mb-3">
													<input class="form-control ch" id="phone"
														type="text" placeholder="010-XXXX-XXXX" name="phone" /> 
														<label for="phone">전화번호</label>
												</div>

												<div class="row mb-2 mt-4 mx-0 px-0">
													<button type="button" id="add_btn" class="btn btn-secondary mb-2">
														사진파일추가
													</button>
												</div>
												<div id="result">
